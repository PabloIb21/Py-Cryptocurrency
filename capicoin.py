...
def mine_block():
    ...
    blockchain.add_transaction(node_address, receiver = 'Pablo Ibarra', amount = 10)
...
def is_chain_valid():
    ...
    if is_valid:
        ...
        response = {'message' : 'Tenemos un problema. La cadena de bloques no es válida.'}
    return jsonify(response), 200
...
def connect_node():
    ...
    response = {'message': 'Todos los nodos han sido conectados. La cadena de CapiCoins contiene ahora los nodos siguientes: ',
